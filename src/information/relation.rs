...
impl Relation{
    pub fn new(name: String)->Self{
        Self{name,from:"".to_string(),sex:"".to_string(), relate_name: "".to_string(), education:Vec::with_capacity(8),
        work:Vec::with_capacity(8),id: PersonId::new()}
    }

    pub fn builder(name: String, from: String, sex: String, relate_name: String, education: Vec<Education>,
        work: Vec<Work>,id: PersonId)->Self{
        Self{name,from,sex,relate_name,education,work,id}
    }
